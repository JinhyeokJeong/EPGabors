...
for MODEL_SEED in 0 1 2 3 4; do
  OUTPUT_DIR="results_resnet50_mean_orientation/classification_sgd_hinge_random_seed${MODEL_SEED}"

  for LAYER in stem layer1_last layer2_last layer3_last layer4_last; do
    echo "Running random SGD hinge classification seed ${MODEL_SEED}, ${LAYER}..."
